...
<form className=' max-w-md mx-auto'>
  <input value={name} onChange={(e)=>setName(e.target.value)} type="text" name="" placeholder='Akash es' id="" />
...
: <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
  ...
  <div className='text-center py-2 text-gray-500'>Already a member
    <Link className='text-black ms-2 underline' to='/login' >Login</Link>
</div>

<button onClick={registerUser} className='primary'>Register</button>
             </div>
    </div>
  )
}
