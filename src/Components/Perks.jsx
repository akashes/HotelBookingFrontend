  ...
  return (
    <div className="grid gap-2 grid-cols-2  md:grid-cols-3 lg:grid-cols-6 mt-2">
              <label className="border p-4 flex rounded-2xl gap-2 items-center cursor-pointer">
                <input type="checkbox"  name="wifi" id="" onChange={(e)=>handleCheckBoxClick(e)} />
                <svg
              ...
              <label className="border p-4 flex rounded-2xl gap-2 items-center cursor-pointer">
                <input type="checkbox" name="parking" id="" onChange={(e)=>handleCheckBoxClick(e)} />
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
              ...
              <label className="border p-4 flex rounded-2xl gap-2 items-center cursor-pointer">
                <input type="checkbox" name="tv" id="" onChange={(e)=>handleCheckBoxClick(e)} />
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
              ...
              <label className="border p-4 flex rounded-2xl gap-2 items-center cursor-pointer">
                <input type="checkbox" name="pets" id="" onChange={(e)=>handleCheckBoxClick(e)} />
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
              ...
              <label className="border p-4 flex rounded-2xl gap-2 items-center cursor-pointer">
                <input type="checkbox" name="entrance" id="" onChange={(e)=>handleCheckBoxClick(e)} />
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
              ...
              <label className="border p-4 flex rounded-2xl gap-2 items-center cursor-pointer">
                <input type="checkbox" name="radio" id="" onChange={(e)=>handleCheckBoxClick(e)} />
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
